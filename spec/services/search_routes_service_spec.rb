...
RSpec.describe SearchRoutesService, :type => :service do
    let!(:route_one)   { FactoryBot.create(:route, name: 'track 1', route_type: 'driver', seats: 1) }
    let!(:route_two)   { FactoryBot.create(:route, name: 'track 2', route_type: 'driver', seats: 1) }
    let!(:route_three) { FactoryBot.create(:route, name: 'track 3', route_type: 'passenger', seats: 1) }
    let!(:route_four)  { FactoryBot.create(:route, name: 'track 4', route_type: 'passenger', seats: 1) }
    let!(:route_five)  { FactoryBot.create(:route, name: 'track 5', route_type: 'passenger', seats: 1) }
  before do    
    FactoryBot.create(:route_point, city_id: 1,point_type: 0, route: route_one)
    FactoryBot.create(:route_point, city_id: 2,point_type: 1, route: route_one)
    FactoryBot.create(:route_point, city_id: 3,point_type: 2, route: route_one)
    FactoryBot.create(:route_point, city_id: 4,point_type: 0, route: route_two)
    FactoryBot.create(:route_point, city_id: 5,point_type: 1, route: route_two)
    FactoryBot.create(:route_point, city_id: 6,point_type: 2, route: route_two)
    FactoryBot.create(:route_point, city_id: 7,point_type: 0, route: route_three)
    FactoryBot.create(:route_point, city_id: 8,point_type: 1, route: route_three)
    FactoryBot.create(:route_point, city_id: 9,point_type: 2, route: route_three)
    FactoryBot.create(:route_point, city_id: 10,point_type: 0, route: route_four)
    FactoryBot.create(:route_point, city_id: 11,point_type: 1, route: route_four)
    FactoryBot.create(:route_point, city_id: 12,point_type: 2, route: route_four)
    FactoryBot.create(:route_point, city_id: 11,point_type: 0, route: route_five)
    FactoryBot.create(:route_point, city_id: 12,point_type: 1, route: route_five)
    FactoryBot.create(:route_point, city_id: 13,point_type: 2, route: route_five)
    FactoryBot.create(:route_point, city_id: 14,point_type: 1, route: route_five)
    FactoryBot.create(:route_point, city_id: 15,point_type: 1, route: route_one)
  end
